...
class questionBank   {
    ...
    // Array that holds questions and answers
    var list = [Question]()
    
    
    //Data Model that contains 13 questions
    init()  {
        
        // Creating a quiz 'item' and appending it to the list variable on line 14
        let item = Question(text: "Valentine\'s day is banned in Saudi Arabia.", correctAnswer: true)
        
        // Add the Question to the list of questions, 'append' adds to the array called 'lsit'
        list.append(item)
